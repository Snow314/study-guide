          ...
          <div class="container mt-2 bg-light p-2 rounded-2 ">
            <div class="justify-content-center">
              <div class="col">
                <form>
                  <div class="mb-3">
                    <label for="topics" class="form-label">Enter topics for your study guide:</label>
                    <input type="text" class="form-control" id="topics" value={topics} placeholder="Topic 1, Topic 2, Topic 3..." onChange={(e) => setTopics(e.target.value)} />
                  </div>
